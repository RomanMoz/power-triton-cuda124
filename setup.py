...
def update_symlink(link_path, source_path):
    ...
    link_path.symlink_to(source_path.absolute(), target_is_directory=source_path.is_dir())
...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        # environment variables we will pass through to cmake (align with build-triton/buildTriton.sh)
        passthrough_args = [
            "TRITON_BUILD_PROTON",
...
backends = [*BackendInstaller.copy(get_codegen_backend_names()), *BackendInstaller.copy_externals()]
...
setup(
    name=os.environ.get("TRITON_WHEEL_NAME", "power-triton-cuda124"),
    version=TRITON_VERSION,
    author="Armlinsoft Team",
    author_email="admin@armlinsoft.net",
    description="Triton fork for ppc64le with CUDA 12.4 support",
    long_description="",
    license="MIT",
    install_requires=[
    ...
    url="https://github.com/RomanMoz/power-triton-cuda124",
    python_requires=PYTHON_REQUIRES,
    classifiers=CLASSIFIERS,
)

# BUILDTRITON_SETUP_PY_PIP_ALIGNMENT
